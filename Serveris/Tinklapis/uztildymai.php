      ...
      <div class="main-container">
         ...
         <div class="nav-bar">
            ...
            <ul> 
                ...
                <li><a href="http://minecraftas.lt/uztildymai.php" class="active">UŽTILDYMAI</a></li>
         ...
         <div class="content">    
             ...
             <?php
             $sql = 
                   "SELECT bm_player_mutes.id, 
                   muted_players.name AS muted_player_name, 
                   actor_players.name AS actor_player_name,
                   bm_player_mutes.reason,
                   bm_player_mutes.created
                   FROM bm_player_mutes
                   JOIN bm_players AS muted_players ON bm_player_mutes.player_id = muted_players.id
                   JOIN bm_players AS actor_players ON bm_player_mutes.actor_id = actor_players.id";
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<tr>';
                echo '<td>' . $row['id'] . '</td>';
                echo '<td><img src="https://mc-heads.net/avatar/' . $row['muted_player_name'] . '/15">' . $row['muted_player_name'] . '</td>';
