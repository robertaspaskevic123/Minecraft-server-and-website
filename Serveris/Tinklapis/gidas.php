  ...
  <div class="main-container">
     ...
     <div class="nav-bar">
        <ul> 
            ...
            <li><a href="http://minecraftas.lt/gidas.php" class="active">KAIP PRADĖTI ŽAISTI?</a></li>
            <li><a href="http://minecraftas.lt/nusizengimai.php">NUSIŽENGIMAI</a></li>
         </ul> 
     </div>
     <div class="content">
      <p>1.Atsisiųskite žaidimą paspaudę<a class="download" href="Minecraft_Installer.exe" download> čia</a><br><br>
         2.Prisijunkite su savo "Minecraft" paskyros duomenimis<br><br>
         3.Įveskite mūsų serverio IP adresą: 78.63.27.125<br><br>
         4.Užsiregistruokite serveryje 
      </p>
     </div>
      
      <div class="footer">
    <p>@ 2023 <span>Minecraftas.lt</span> | Visos teisės saugomos</p>
    </div>
  </div>
 </body>
