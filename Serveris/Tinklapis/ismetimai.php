  ...
  <div class="main-container">
     ...
     <div class="nav-bar">
        ...
        <ul> 
            ...
            <li><a href="http://minecraftas.lt/ismetimai.php" class="active">IŠMETIMAI</a></li>
         </ul> 
     </div>
     <div class="content">    
         ...
         <?php
             $sql = 
                   "SELECT bm_player_kicks.id, 
                   kicked_players.name AS kicked_player_name, 
                   actor_players.name AS actor_player_name,
                   bm_player_kicks.reason,
                   bm_player_kicks.created
                   FROM bm_player_kicks
                   JOIN bm_players AS kicked_players ON bm_player_kicks.player_id = kicked_players.id
                   JOIN bm_players AS actor_players ON bm_player_kicks.actor_id = actor_players.id";
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<tr>';
                echo '<td>' . $row['id'] . '</td>';
                echo '<td><img src="https://mc-heads.net/avatar/' . $row['kicked_player_name'] . '/15">' . $row['kicked_player_name'] . '</td>';
